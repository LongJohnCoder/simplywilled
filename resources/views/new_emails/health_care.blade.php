                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600" class="container">
                    ...
                    <tr>
                        <td style="padding:0 30px; background: #f2f2f2;">
                            <h1 style="color: #0a5dab; font-size: 30px; padding: 30px 0 20px;">Health Care Power of Attrney {{ucwords(strtolower($executiveFirstName . ' ' . $executiveLastName))}} (1st Choice), </h1>
