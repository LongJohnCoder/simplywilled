                    ...
                    <tr>
                        <td style="padding:0 30px; background: #f2f2f2;">
                            <p style="color: #373737; font-size: 20px; line-height: 30px; padding-top: 32px; padding-bottom: 32px;">
                                ...
                                {{ucwords(trim($firstName))}} recently joined the thousands of people who have used <a href="{{env('BASE_URL')}}" target="_blank" style="font-weight: bold; color:#0a5dab;">SimplyWilled.com</a> to create their last will and testament and supporting estate plan documents.<br><br>
