                        ...
                        <td style="padding:0 30px; background: #f2f2f2;">
                            ...
                            <p style="color: #373737; font-size: 20px; line-height: 30px;">
                              You have been appointed as Backup Pet Caretaker.<br><br>
                                    <strong>{{ucwords(strtolower($firstName.' '.$middleName.' '.$lastName))}}</strong> recently joined the thousands of people who have used <a href="{{env('BASE_URL')}}" target="_blank" style="color: #0a5dab;">SimplyWilled.com</a> to create their will and selected you to serve as their backup pet caretaker on their demise. Being selected as a Backup Pet Caretaker is an important role reserved for those we trust the most. This email is being sent to you so you can let <strong>{{ucwords(strtolower($firstName.' '.$middleName.' '.$lastName))}}</strong> know whether you accept or decline this honor.
                                <br><br>
