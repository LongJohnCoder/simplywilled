                      ...
                      @endphp
                        <td style="padding:0 30px; background: #f2f2f2;">
                            ...
                            <p style="color: #373737; font-size: 20px; line-height: 30px;">
                              You have been appointed as Backup Health Care Agent.<br><br>
                                    <strong>{{ucwords(strtolower($firstName.' '.$middleName.' '.$lastName))}}</strong> recently joined the thousands of people who have used <a href="{{env('BASE_URL')}}" target="_blank" style="color: #0a5dab;">SimplyWilled.com</a> to create their will and selected you to serve as their Backup Healthcare Power of Attorney. Being selected as a Backup Healthcare Power of Attorney is an important role reserved for those we trust the most. This email is being sent to you so you can let <strong>{{ucwords(strtolower($firstName))}}</strong> know whether you accept or decline this honor.
                                <br><br>
                                <strong style="font-size: 22px;">What being selected as Backup Healthcare Power of Attorney means for You:</strong>
                                <br><br>
                                As the Backup Healthcare Power of Attorney you will be legally responsible for making medical decision for <strong>{{ucwords(strtolower($firstName))}}’s</strong> in the event they are  incapacitated. Serving as a Backup Healthcare Power of Attorney is a very important role and carries with is significant powers should you be called upon to serve. Among them commonly, people give their healthcare agent broad power to medical decisions on their behalf.
                                <br><br>
