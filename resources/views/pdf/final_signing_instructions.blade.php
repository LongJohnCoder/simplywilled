...
<body>
	<div>
		<div class="doc-container" style="border: 1px solid #000; padding: 15px; box-sizing: border-box; padding: 20px; height: 890px;">
			...
			<div>
				<p style="font-size: 17px; margin: 20px 0 10px; text-decoration: underline; font-family: Garamond;">
				...
				<p class="para2" style="font-size: 15px; margin: 0 20px 15px; font-family: Garamond;">
					First, you will need a <u>Blue Ink Pen</u>. <br>
	            ...
	            <p style="font-size: 15px; margin: 0 0 15px; font-family: Garamond;">
	              Please be sure to have two witnesses and a notary public present when you sign your Last Will and Testament.
	              Both of your witnesses and the notary must all be present when you sign your Last Will and Testament. Your
	              witnesses must see you sign, and additionally your witnesses must see each other sign. This should all be done
	              in the presence of the notary public.
	            </p>

	            <p style="font-size: 15px; margin: 0 0 15px; font-family: Garamond;">
	              Don,t forget, your witnesses should be adults, over the age of 18, who are not beneficiaries or fiduciaries of
	              your estate.
	            </p>
		...
		<div class="doc-container" style="border: 1px solid #000; padding: 15px; box-sizing: border-box; padding: 20px; height: 890px;">
			<ul style="margin: 20px 0 20px 20px">
					<li style="margin-bottom: 10px; font-size: 15px; font-family: Garamond;">
					...
					<li style="margin-bottom: 10px; font-size: 15px; font-family: Garamond;">
						Witnesses should sign their names to your Last Will and Testament on the provided witness signature lines <span style="text-decoration: underline;">after</span> you’ve signed your name.
					</li>
					<li style="margin-bottom: 10px; font-size: 15px; font-family: Garamond;">
				...
				<ul style="margin: 20px 0 20px 20px">
					...
					<li style="margin-bottom: 10px; font-size: 15px; font-family: Garamond;">
						Witnesses should sign their names to your supporting documents on the provided witness signature lines <span style="text-decoration: underline;">after</span> you’ve signed your name.
					</li>
					<li style="margin-bottom: 10px; font-size: 15px; font-family: Garamond;">
				...
				<p style="font-size: 15px; margin: 0 0 15px; padding-top:20px; font-family: Garamond; text-align: center; font-weight: bold;">
					Congratulations you’re done!  It’s that simple.<br>
