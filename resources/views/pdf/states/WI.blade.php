...
<div style="text-align: justify;">
    ...
    <div>
        ...
        to establish a long-term relationship with you, they are often</b></span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt"><b>
        ...
        the person whom you want to make health care decisions for you if</b></span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt"><b>
        </b></span></span><span  style="font-size: 12pt"><b>you are
        unable to make those decisions personally. That person is known as</b></span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt"><b>
        your health care agent. You should take some time to discuss your
        thoughts and beliefs about medical treatment with the person or
        persons </b></span></span><span  style="font-size: 12pt"><b>whom
        you have specified. You may state in this document any types of
        health</b></span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt"><b>
        care that you do or do not desire, and you may limit the authority of
        your health care agent. If your health care agent is unaware of your
        desires </b></span></span><span  style="font-size: 12pt"><b>with
        respect to a particular health care decision, he or she is required
        ...
        attorney for health care that you may have made. If you wish to
        change your power of attorney for health care, you may revoke this
        document at </b></span></span><span  style="font-size: 12pt"><b>any
        time by destroying it, by directing another person to destroy it in
        your</b></span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt"><b>
        presence, by signing a written and dated statement or by stating that
        it is </b></span></span><span  style="font-size: 12pt"><b>revoked
        in the presence of two witnesses. If you revoke, you should notify</b></span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt"><b>
        your agent, your health care providers and any other person to whom
        you have given a copy. If your agent is your spouse and your marriage
        ...
        make an anatomical gift, this document revokes any prior document of
    ...
    <div>
        ...
        for health care. My executing this power of attorney for health care
        is voluntary. Despite the creation of this power of attorney for
        ...
        am able. For the purposes of this document, “health care decision”
        means </span></span><span style="letter-spacing: 0.1pt"><span style="font-family:'Times New Roman, serif'">an
        informed decision to accept, maintain, discontinue or refuse any
        ...
        <span color="#000000">
          ...
          or unwilling to act as my agent</span></span><span style="font-family:'Times New Roman, serif'">,
          </span>

          <span color="#000000">
                <span style="font-family:'Times New Roman, serif'">I
              hereby designate my </span>
              </span>
              <span color="#0433ff">
      ...
      <span color="#000000"><span color="#00000a"><span style="font-family:'Times New Roman, serif'">
        </span></span></span><span style="letter-spacing: 0.1pt"><span style="font-family:'Times New Roman, serif'">Neither
        my health care agent nor my alternate health care agent whom I have
        designated is my health care provider, an employee of my health care
        provider, an employee of a health care facility in which I am a
        patient or a spouse of any of those persons, unless he or she is also
        my relative.  For purposes of this document, “incapacity” exists
        if 2 physicians or a physician and a psychologist who have personally
        examined me sign a statement that specifically expresses their
        opinion that I have a condition that means that I am unable to
        ...
        my health care agent, if I need treatment, for all of my health</span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt">
        care and treatment. I have discussed my desires thoroughly with my
        </span></span><span  style="font-size: 12pt">health care
        agent and believe that he or she understands my philosophy</span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt">
        ...
        specific proposed health care if I am able to communicate in any
        ...
        If I have not expressed a health care choice about the health care in
        question and communication cannot be made, my health care agent shall
        base his or her health care decision on what he or she believes to be
        ...
        treatment facility. My health care agent may not consent to
        ...
        advised that, in his or her professional judgment, this will</span><span style="letter-spacing: 0.1pt"><span  style="font-size: 12pt">
        cause me pain or will reduce my comfort. If I have checked “No”
    ...
    <div>
        ...
        to, those relating to any diagnosis, treatment or prognosis or bills.
        This authorization includes, but is not limited to, records regarding
        mental illness, developmental disabilities, alcoholism or drug usage
        or dependence. This authorization permits any health care provider of
        mine to confer with and furnish written reports or copies of any and
        all health care records to my health care agent and to allow my
        health care agent to inspect the originals of any health care record
        ...
        attorney-in-fact, without restriction, all of my individually
        ...
        authority given my attorney-in-fact shall supersede any other
        ...
        health information. This authority given my attorney-in-fact shall be
    ...
    <div style="page-break-before: always">
        ...
        OF WITNESSES</b></span></span></span></p>
            <p  style="text-indent: 0.38in; margin-bottom: 0in;  ">
        <span style="font-family:'Times New Roman, serif'"><span size="1" style="font-size: 12pt"><span style="letter-spacing: 0.4pt"><span  style="font-size: 12pt">I
        ...
        <span  style="font-size: 12pt"></span><span style="letter-spacing: 0.3pt"><span  style="font-size: 12pt">
        execution</span></span><span style="letter-spacing: 0.4pt"><span  style="font-size: 12pt">
        </span></span><span style="letter-spacing: 0.3pt"><span  style="font-size: 12pt">of
        this power of attorney for health care is voluntary. I am at least 18
        years</span></span><span style="letter-spacing: 0.4pt"><span  style="font-size: 12pt">
        </span></span><span style="letter-spacing: 0.3pt"><span  style="font-size: 12pt">of
        age, am not related to the principal by blood, marriage or adoption
        and</span></span><span style="letter-spacing: 0.4pt"><span  style="font-size: 12pt">
        </span></span><span style="letter-spacing: 0.3pt"><span  style="font-size: 12pt">am
        not directly financially responsible for the principal’s health
        care. I am</span></span><span style="letter-spacing: 0.4pt"><span  style="font-size: 12pt">
        not a health care provider who is serving the principal at this time,
        an employee of the health care provider, other than a chaplain or a
        social worker, or an employee, other than a chaplain or a social
        worker, of an </span></span><span style="letter-spacing: 0.3pt"><span  style="font-size: 12pt">inpatient
        health care facility in which the declarant is a patient. I am not</span></span><span style="letter-spacing: 0.4pt"><span  style="font-size: 12pt">
    ...
    <div style="page-break-before: always">
        ...
        <span style="font-family:'Times New Roman, serif'">
          <span size="2" style="font-size: 10pt">
            ...
            care agent or alternate health care agent if </span>
            ...
            ever found to have incapacity and unable to make health care
            decisions for </span>
    ...
    <div >
        ...
        blood,</span></span><span  style="font-size: 12pt"> marriage
    ...
    <div style="page-break-before: always">
        ...
        is the attending physician, have personally examined and certified</span></span><span  style="font-size: 12pt">
        in writing that the patient has a terminal condition or is in a
        persistent vegetative state.</span></span></span></p>
                </li>
        ...
        or feeding tubes would cause the patient pain or reduced comfort and
        that </span><span style="letter-spacing: -0.1pt"><span  style="font-size: 12pt">the
        pain or discomfort cannot be alleviated through pain relief
        measures.</span></span><span  style="font-size: 12pt"> If
        the patient’s stated desires are that life-sustaining procedures
        or feeding tubes be used, this directive must be followed.</span></span></span></p>
                </li>
