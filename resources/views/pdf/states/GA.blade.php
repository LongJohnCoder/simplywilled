    ...
    <div>
        ...
        <div>
            <div>
                ...
                <p class="western" style="margin-left: 1.5in; text-indent: -1.5in; margin-bottom: 0in; line-height: 100%">
        ...
        <div>
            <div>
                <p class="western" style="margin-top: 0.13in; margin-bottom: 0.03in; line-height: 100%; text-align:center;">
                ...
                <ol>
                    <li>
                      <p style="margin-top: 0.19in; margin-bottom: 0.13in; line-height: 100%">
                ...
                <p class="western" style="margin-left: 1.13in; text-indent: -1.13in; margin-bottom: 0in; line-height: 100%">
                ...
                <p class="western" style="margin-top: 0.19in; margin-bottom: 0.13in; line-height: 100%">
                ...
                @if($healthFinance['anyBackupAgent'] == 'true')
                    ...
                    <p class="western" style="margin-bottom: 0in; line-height: 100%"><span>{{ucwords($healthFinance['backupCity'])}}, {{ucwords($healthFinance['backupState'])}} {{ucwords($healthFinance['backupZip'])}}</span></p>
                    <p class="western" style="margin-left: 1.13in; text-indent: -1.13in; margin-bottom: 0in; line-height: 100%">
        ...
        <div>
            <div>
                ...
                <ul>
                    <li>
                    <p style="margin-bottom: 0.17in; line-height: 100%"><span style="font-family:'Calibri, serif'"><span style="font-family:'Times New Roman, serif'">To authorize my admission to or discharge (including transfers) from any hospital, skilled nursing facility, hospice, or other health care facility or service; </span></span>
                    </p></li>
                </ul>
                <p style="margin-left: 0.5in; margin-bottom: 0.17in; line-height: 100%">

                </p>
                <ul>
                    <li>
                    <p style="margin-bottom: 0.17in; line-height: 100%"><span style="font-family:'Calibri, serif'"><span style="font-family:'Times New Roman, serif'">To	request, consent to, withhold, or withdraw any type of health care; and to</span></span>
                    </p></li>
                </ul>
                <p style="margin-left: 0.5in; margin-bottom: 0.17in; line-height: 100%">
                </p>
                <ul>
                    <li>
                    <p style="margin-bottom: 0.17in; line-height: 100%"><span style="font-family:'Calibri, serif'"><span style="font-family:'Times New Roman, serif'">Contract for any health care facility or service for me, and to obligate me to pay for these services (and my health care agent, acting in this official capacity, will not be financially liable for any services or care contracted for me or on my behalf).</span></span>
                    </p></li>
                </ul>
                <p class="western" style="margin-bottom: 0in; line-height: 100%">
        ...
        <div>
            <div>
                ...
                <p class="western" style="margin-left: 1.5in; text-indent: -1.5in; margin-bottom: 0.06in; line-height: 100%">
                ...
                <p class="western" style="margin-left: 2.5in; text-indent: -1.5in; margin-bottom: 0.06in; line-height: 100%">
                ...
                <p class="western" style="margin-left: 1.5in; text-indent: -0.5in; margin-bottom: 0.06in; line-height: 100%">
                    <br/>
                    <br/>
                ...
                <p class="western" style="margin-bottom: 0in; line-height: 100%">I have provided instructions for the final disposition of my body in a separate written document.</p>
                <p class="western" style="margin-top: 0.25in; margin-bottom: 0.03in; line-height: 100%">
                    <br/>
                    <br/>

                </p>
                <p class="western" style="margin-top: 0.25in; margin-bottom: 0.03in; line-height: 100%; text-align:center;">
        ...
        <div>
            <div>
                ...
                <p class="western" style="text-indent: 0.5in; margin-bottom: 0.06in; line-height: 100%">
                ...
                <p class="western" style="margin-left: 0.5in; text-indent: -0.5in; margin-bottom: 0.06in; line-height: 100%">
                ...
                <p class="western" style="margin-left: 1.5in; text-indent: -1in; margin-bottom: 0.06in; line-height: 100%">
                    <u><b>OR</b></u></p>
            </div>
            <!-- <div style="text-align: center; padding-top: 5px; border-top: 1px solid #000; font-size: 12px; font-family: Times New Roman, serif;">
                Advance Directive for Health Care of
        ...
        <div>
            <div>
                ...
                <p class="western" style="margin-left: 1.38in; text-indent: 0.13in; margin-bottom: 0.06in; line-height: 100%">
                    <br/>
                    <br/>

                </p>
                <p class="western" style="margin-left: 1in; text-indent: 0.13in; margin-bottom: 0.06in; line-height: 100%">
                    <i><b>[Initial each statement that you want to apply to option (C).]</b></i></p>
                <!-- <p class="western" style="margin-left: 1.5in; text-indent: -1.5in; margin-bottom: 0.06in; line-height: 100%">
                </p> -->
                <p class="western" style="margin-left: 1.5in; margin-bottom: 0.06in; line-height: 100%">
        ...
        <div>
            <div>
                ...
                <p class="western" style="margin-top: 0.19in; margin-bottom: 0.03in; line-height: 100%">
                    <br/>
                    <br/>

                </p>
                <p class="western" style="margin-top: 0.19in; margin-bottom: 0.03in; line-height: 100%; text-align:center;">
                ...
                <p class="western" style="margin-left: 1.69in; text-indent: -1.69in; margin-bottom: 0.06in; line-height: 100%">
        ...
        <div>
            <div>
                ...
                <p class="western" style="margin-bottom: 0.06in; line-height: 100%">
                    A witness:</p>
                <p class="western" style="margin-left: 0.19in; text-indent: -0.19in; margin-bottom: 0.06in; line-height: 100%">
                ...
                <p class="western" style="margin-left: 0.19in; text-indent: -0.19in; margin-bottom: 0in; line-height: 100%">
        ...
        <div>
            <div>
                ...
                <p class="western" style="margin-bottom: 0in; line-height: 100%">
                    <span><u>_____________________________________________</u></span><span>	</span><span><b>	</b></span><span>(Date)</span><span><u>___________________</u></span></p>
                <p class="western" style="margin-bottom: 0.08in; line-height: 100%; orphans: 0; widows: 0">
                    <a name="_GoBack"></a>
                    <span>{{ucwords($tellUsAboutYou['fullname'])}}</span></p>
                <p class="western" style="margin-bottom: 0in; line-height: 100%">
                    (Signature of Declarant)</p>
            </div>
            <!-- <div style="text-align: center; padding-top: 5px; border-top: 1px solid #000; font-size: 12px; font-family: Times New Roman, serif;">
                Advance Directive for Health Care of
                <br> {{ucwords($tellUsAboutYou['fullname'])}}
        ...
        <div>
            <div>
                ...
                <p align="left" style="margin-left: 0.19in; text-indent: -0.19in; margin-bottom: 0in; line-height: 100%">
                    <br/>

                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt"><b>WITNESS 1</b></span></span>
                    </span><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">: ________________________________	Dated: ___________________</span></span>
                    </span>
                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">[signature]</span></span>
                    </span>
                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%">
                    <br/>
                ...
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">____________________________________</span></span>
                    </span>
                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">	[name printed]</span></span>
                    </span>
                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%">
                    <br/>
                ...
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">	[street address]</span></span>
                    </span>
                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%">
                    <br/>
                ...
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">	[city, state]</span></span>
                    </span>
                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%">
                    <br/>
                ...
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt"><b>WITNESS 2: </b></span></span>
                    </span><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">________________________________	Dated: ___________________</span></span>
                    </span>
                </p>
                <p style="margin-bottom: 0.06in; line-height: 100%"><span><span style="font-family:'Times New Roman, serif'"><span size="2" style="font-size: 11pt">[signature]</span></span>
                ...
                <p class="western" style="margin-bottom: 0in; line-height: 100%"><i><b>[This form does not need to be notarized and a copy of a validly executed advance directive for health care carries the same meaning and effect as the original document.]</b></i></p>
            </div>
            <!-- <div style="text-align: center; padding-top: 5px; border-top: 1px solid #000; font-size: 12px; font-family: Times New Roman, serif;">
                Advance Directive for Health Care of
                <br> {{ucwords($tellUsAboutYou['fullname'])}}
