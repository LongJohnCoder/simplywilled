...
<div class="docContainer" id="doc">
    ...
    WILL”)</b></span></span></span></p>
      ...
      care agent&quot; to decide treatment for you, and a living will,
      where you tell your health care agent and health care providers your
      ...
      health care agent the power to speak for you immediately. This
      combined document gives your health care agent the power to speak for
      you only when you are unable to speak for yourself.</span><span size="3" style="font-size: 12pt">&nbsp;</span><span size="3" style="font-size: 12pt">A
      living will cannot be followed unless your attending physician
      determines that you lack the ability to understand, make, and
      communicate health care decisions for yourself and you are either
      permanently unconscious or you have an end-stage medical condition,
      which is a condition that will result in death despite the
    ...
    whom you expect would likely attend to your needs if you become
    unable to understand, make, or communicate decisions about medical
    ...
    <div class="docPage" style="margin:0; box-sizing: border-box; padding: 0px;">
      ...
      person that you have appointed him or her as your health care agent
      ...
      create your own advance health care directive to convey your wishes
      ...
      different document or create your own. YOU SHOULD ALSO USE A
      DIFFERENT DOCUMENT IF YOU WISH TO EXPRESS YOUR PREFERENCES IN MORE
      DETAIL THAN THIS DOCUMENT ALLOWS OR IF YOU WISH FOR YOUR HEALTH CARE
    ...
    <div class="docPage" style="margin:0; box-sizing: border-box; padding: 0px;">
      ...
      it directs that life-sustaining treatment, including nutrition and
      ...
      other covered entities to disclose to my health care agent, upon my
      agent's request, any information, oral or written, regarding my
      physical or mental health, including, but not limited to, medical and
      hospital records and what is otherwise private, privileged, protected
      or personal health information, such as health information as defined
      and described in the Health Insurance Portability and Accountability
      Act of 1996 (Public Law 104-191, 110 Stat. 1936), the regulations
      promulgated thereunder and any other State or local laws and rules.
      Information disclosed by a health care provider or other covered
    ...
    <div class="docPage" style="margin:0; box-sizing: border-box; padding: 0px; page-break-after: always;">
      ...
      <span style="font-family: 'Times New Roman; serif'"> as my Agent to make medical treatment decisions for me</span>.
      ...
      required</span></span></span><span ><span size="3" style="font-size: 12pt">.</span></span><span ><span size="3" style="font-size: 12pt">&nbsp;</span></span></span></span></span></p>
      ...
      document, I appoint my
            ...
            @if(isset($healthFinance) && array_key_exists('backupAddress',$healthFinance) && !is_null($healthFinance['backupAddress']))
                <span style="font-family:'Times New Roman, serif'">{{ucwords(strtolower($healthFinance['backupAddress']))}}, </span>
            @else
                <span>
                    _________________________________________________________________
                    _______________________________________________________________________________,
    ...
    <div class="docPage" style="margin: 0; box-sizing: border-box; padding:0px;page-break-after: always;">
      ...
      aggressive medical care to be burdensome. I therefore request that my
      health care agent respond to any intervening (other and separate)
    ...
    health care agent must follow these instructions.</span></span></span></p>
      ...
      agent's direction. On behalf of myself, my executors and heirs, I
      further hold my health care agent and my health care providers
