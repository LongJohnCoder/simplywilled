	...
	<div class="docPage" style="margin: 20px 0; box-sizing: border-box; padding: 40px;">
			<div class="docPageInner" style="box-sizing: border-box; height: 875px;">
				<p  style="margin-bottom: 0in; line-height: 100%; text-align:center;"><span style="font-family:'Times New Roman, serif'"><span size="4" style="font-size: 14pt"><b>NEVADA
					...
					limitations or statement of your desires that you include in this
					...
					if you are unable to make health care decisions for yourself, this
					...
					informed consent with respect to the particular decision. In
		...
		<div class="docPage" style="margin: 20px 0; box-sizing: border-box; padding: 40px;">
			<div class="docPageInner" style="box-sizing: border-box; height: 875px;">
				...
				ANSWERED( Address2 )</span></span>
				<span><span ><span style="font-family:'Times New Roman, serif'">»«</span></span></span>

				<span style="font-family:'Times New Roman, serif'"><span size="1" style="font-size: 6pt"><span ><span size="3" style="font-size: 12pt">Address2</span></span></span></span>

				<span ><span ><span style="font-family:'Times New Roman, serif'">»,
				«</span></span></span>
				<span ><span style="font-family:'Times New Roman, serif'">END
				IF</span></span>
				--}}
				...
				<span style="font-family:'Times New Roman, serif'">
					<span size="1" style="font-size: 6pt">
						<span>
							<span size="3" style="font-size: 12pt">{{ucwords(strtolower($healthFinance['fullname']))}}</span>
						</span>
					</span>
				</span>
				...
				<span style="font-family:'Times New Roman, serif'">
					<span size="1" style="font-size: 6pt">
						<span>
							<span size="3" style="font-size: 12pt">{{$healthFinance['address']}}</span>
						</span>
					</span>
				</span>
				...
				<span style="font-family:'Times New Roman, serif'">
					<span size="1" style="font-size: 6pt">
						<span>
							<span size="3" style="font-size: 12pt">{{$healthFinance['phone']}}</span>
						</span>
					</span>
				</span>
				...
				<span>
					<span>
						<span style="font-family:'Times New Roman, serif'">as my </span>
					</span>
				</span>
				<span>
					<span>
						<span style="font-family:'Times New Roman, serif'">Agent to make health care decisions for me as authorized in this document.</span>
					</span>
				</span>
				...
				for me before or after my death, including consent, refusal of
				...
				condition; to request, review and receive any information, verbal or
				written, regarding my physical or mental health, including, without
				limitation, medical and hospital records; to execute on my behalf any
				releases or other documents that may be required to obtain medical
				care and/or medical and hospital records, EXCEPT any power to enter
				into any arbitration agreements or execute any arbitration clauses in
				...
				any other types of treatment or placement that you do not want your
				agent’s authority to give consent for or other restrictions you
				wish to place on his or her authority, you should list them in the
				space below. If you do not write any limitations, your agent will
		...
		<div class="docPage" style="margin: 20px 0; box-sizing: border-box; padding: 40px;">
			<div class="docPageInner" style="box-sizing: border-box; height: 875px;">
				...
				health care decisions for myself when this power of attorney expires,
				...
				indicate your desires below. If your desires are unknown, your agent
				has the duty to act in your best interests; and, under some
				circumstances, a judicial proceeding may be necessary so that a court
		...
		<div class="docPage" style="margin: 20px 0; box-sizing: border-box; padding: 40px;">
			<div class="docPageInner" style="box-sizing: border-box; height: 875px;">
				...
				in the event that he or she is unable or unwilling to act as your
				...
				<span size="2" style="font-size: 9pt">
					<span>
						<span size="3" style="font-size: 12pt"> IF Rx Alternate Agents1?</span>
					</span>
					...
					<span style="font-family:'Times New Roman, serif'">
						<span size="1" style="font-size: 7pt">
							...
							<span style="font-family:'Times New Roman, serif'">
								<span size="1" style="font-size: 6pt">
									<span>
										<span size="3" style="font-size: 12pt">{{$healthFinance['backupFullname']}}</span>
									</span>
								</span>
							</span>
							...
							<span style="font-family:'Times New Roman, serif'">
								<span size="1" style="font-size: 6pt">
									<span>
										<span size="3" style="font-size: 12pt">{{$healthFinance['backupAddress']}}</span>
									</span>
								</span>
							</span>
							...
							<span>
								<span size="3" style="font-size: 12pt">{{$healthFinance['backupCity']}}</span>
							</span>

							<span size="3" style="font-size: 12pt">, </span>

							<span>
								<span size="3" style="font-size: 12pt">{{$healthFinance['backupState']}}</span>
							</span>
							...
							<span size="3" style="font-size: 12pt">), as my alternate Agent to make health care decisions for me as
				...
				<p style="margin-bottom: 0in; line-height: 100%">
					<span style="font-family:'Times New Roman, serif'">If
						...
						to serve as my agent to make heath care decisions for me as
						authorized in this document, such person to serve in the order listed
						below:</span>
				</p>
				@endif
		...
		<div class="docPage" style="margin: 20px 0; box-sizing: border-box; padding: 40px;">
			<div class="docPageInner" style="box-sizing: border-box; height: 875px;">
				...
				<ol type="A">
				<li>
				<p style="margin-bottom: 0in; line-height: 100%"><span style="font-family:'Times New Roman, serif'">First
				...
				<p style="margin-left: 0.5in; margin-bottom: 0in; line-height: 100%"><span style="font-family:'Times New Roman, serif'">Name:
				...
				<p style="margin-left: 0.5in; margin-bottom: 0in; line-height: 100%"><span style="font-family:'Times New Roman, serif'">Address:
				________________________________________________________________</span></p>
				<p style="margin-left: 0.5in; margin-bottom: 0in; line-height: 100%"><br/>

				</p>
				<p style="margin-left: 0.5in; margin-bottom: 0in; line-height: 100%"><span style="font-family:'Times New Roman, serif'">	________________________________________________________________</span></p>
				<p style="margin-left: 0.5in; margin-bottom: 0in; line-height: 100%"><br/>

				</p>
				<p style="margin-left: 0.5in; margin-bottom: 0in; line-height: 100%"><span style="font-family:'Times New Roman, serif'">Telephone
				...
				<p style="margin-bottom: 0in; line-height: 100%"><span style="font-family:'Times New Roman, serif'">Second
					Alternative Agent</span></p>
				</li>
				</ol>
				...
				<p style="margin-left: 0.5in; margin-bottom: 0in; line-height: 100%"><span style="font-family:'Times New Roman, serif'">	_________________________________________________________________</span></p>
				...
				commence an action for declaratory judgment as to the legality of the
				provision in question. The cost of any such action is to be paid from
				my estate. This Durable Power of Attorney for Health Care must be
				...
				consideration by the court my agent herein named.</span></p>
			</div>
		</div>
		...
		<div class="docPage" style="margin: 20px 0; box-sizing: border-box; padding: 40px;">
			<div class="docPageInner" style="box-sizing: border-box; height: 875px;">
				...
				before me, ________________________, a Notary Public, personally
				appeared </span>
				<span>
				...
				instrument, and acknowledged that </span>
				<span>
		...
		<div class="docPage" style="margin: 20px 0; box-sizing: border-box; padding: 40px;">
			<div class="docPageInner" style="box-sizing: border-box; height: 875px;">
				...
				<span style="font-family:'Times New Roman, serif'"><span style="letter-spacing: 0.1pt">»,
				</span></span><span style="font-family:'Times New Roman, serif'">the principal, is
				personally known to me, that the principal signed or acknowledged
				this durable power of attorney in my presence, that the principal
				appears to be of sound mind and under no duress, fraud, or undue
				influence, that I am not the person appointed as agent by this
				document, and that I am not a provider of health care, an employee of
				...
				part of the estate of the principal upon </span>

				<span>
					<span style="font-family:'Times New Roman, serif'">{{$genderTxt4}}</span>
				</span>

				<span style="font-family:'Times New Roman, serif'"> death under a will now existing or by operation of law.</span></p>
				<p  style="margin-bottom: 0in; line-height: 100%"><br/>
