...
<div class="docContainer" id="doc">
    ...
    <div class="docPage" style="margin: 0; box-sizing: border-box; padding: 0px;">
      ...
      designate and appoint my
        ...
        <span >),
      as my attorney in fact (agent) to make health care decisions for me
      as authorized in this document.  For the purposes of this document,
    ...
    health care.</span></span></p>
      ...
      care decisions for me to the same extent that I could make such
      decisions for myself if I had the capacity to do so.  In exercising
      this authority, my agent shall make health care decisions that are
      consistent with my desires as stated in this document or otherwise
    ...
    <div class="docPage" style="margin: 0; box-sizing: border-box; padding: 0px;">
      ...
      include a statement of your desires concerning life-prolonging care,
      treatment, services, and procedures. You can also include a statement
      of your desires concerning other matters relating to your health
      care. You can also make your desires known to your agent by
      discussing your desires with your agent or by some other means. If
      there are any types of treatment that you do not want to be used, you
      should state them in the space below. If you want to limit in any
      other way the authority given your agent by this document, you should
      ...
      mandate that withholding or withdrawing.</span></span></p>
        ...
        <!-- @if(isset($tellUsAboutYou) && array_key_exists('fullname',$tellUsAboutYou) && !is_null($tellUsAboutYou['fullname']))
            <div style="text-align: center; padding-top: 5px; border-top: 1px solid #000; font-size: 12px; font-family: Times New Roman, serif;">
                Durable Power of Attorney for Health Care of {{strtoupper($tellUsAboutYou['fullname'])}}<br>
                Page 3 of 10
            </div>
        @else
            <div style="text-align: center; padding-top: 5px; border-top: 1px solid #000; font-size: 12px; font-family: Times New Roman, serif;">
      ...
      PAGES AT THE SAME TIME YOU DATE AND SIGN THIS POWER OF ATTORNEY.)</span></span></p>
            ...
            <p class="western"  style="margin-bottom: 0.08in;  orphans: 0; widows: 0">
                ...
                undersigned notary public, personally appeared <b>
                    ...
                    @endif
            </b><span ><b> </b></span>personally
                known to the notary or proved to the notary through satisfactory
                evidence of identification, to be the person whose name is signed on
    ...
    of the following may be used as a witness:</span></span></p>
      ...
      sound mind and under no duress, fraud, or undue influence, that I am
