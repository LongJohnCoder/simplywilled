        ...
        this.personalRepresentativeDetailsForm = this.fb.group({
            ...
            personalRepresentative: this.fb.array([
              this.fb.group({
                    ...
                    relationship_other: new FormControl(guardian !== null && guardian.relationship_other !== null ?  (guardian.relationship_with === 'Other' ? guardian.relationship_other : '') : '', guardian.relationship_with === 'Other' ? [Validators.required] : []),
            ...
            backupPersonalRepresentative: this.fb.array([
              this.fb.group({
                  ...
                  relationship_other: new FormControl(backupGuardian !== null && backupGuardian.relationship_other !== null ?  (backupGuardian.relationship_with === 'Other' ? backupGuardian.relationship_other : '') : ''),
