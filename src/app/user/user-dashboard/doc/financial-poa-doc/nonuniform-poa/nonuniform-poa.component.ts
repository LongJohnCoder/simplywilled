...
@Component({
  selector: 'app-nonuniform-poa',
  templateUrl: './nonuniform-poa.component.html',
  styleUrls: ['./nonuniform-poa.component.css']
})
export class NonuniformPoaComponent implements OnInit, OnChanges {
