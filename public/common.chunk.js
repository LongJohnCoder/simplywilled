...
/***/ "./src/app/admin/auth/admin-login/admin-login.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AdminLoginService = /** @class */ (function () {
    function AdminLoginService(httpClient) {
        this.httpClient = httpClient;
    }
    AdminLoginService.prototype.login = function (body) {
        return this.httpClient.post(__WEBPACK_IMPORTED_MODULE_2__environments_environment_prod__["a" /* environment */].API_URL + 'admin-panel/sign-in', body);
    };
...
/***/ "./src/app/admin/auth/change-password/change-password.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ChangePasswordService = /** @class */ (function () {
    ...
    ChangePasswordService.prototype.resetPass = function (body1) {
        return this.httpClient.post(__WEBPACK_IMPORTED_MODULE_2__environments_environment_prod__["a" /* environment */].API_URL + 'admin-panel/change-password', body1);
    };
...
/***/ "./src/app/user/user-dashboard/user-dashboard.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UserDashboardService; });
...
var UserDashboardService = /** @class */ (function () {
    function UserDashboardService() {
        this.userDetails = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["a" /* Subject */]();
        this.step1Data = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["a" /* Subject */]();
    }
    UserDashboardService.prototype.updateUserDetails = function (value) {
